      ...
      <ScrollView className="page-content" scrollY>
        ...
        {order.user_open_id && (
          <View className="user-info-section">
            <View className="section-title">用户信息</View>
            <View className="user-info">
              <View className="user-detail">
                <Text className="detail-label">用户ID:</Text>
                <Text className="detail-value">{order.user_open_id}</Text>
              </View>
            </View>
          </View>
        )}
