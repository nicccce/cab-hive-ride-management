...
#### 请求参数
```
(out_trade_no=123456&trade_no=2025071622001234567890&trade_status=TRADE_SUCCESS&total_amount=100.00&...)
```
...
#### 请求参数
```
?out_trade_no=123456&trade_no=2025071622001234567890&trade_status=TRADE_SUCCESS&sign=...
```
...
<body>
    <h1>支付成功</h1>
    <p>订单号: 123456</p>
    <p>交易号: 2025071622001234567890</p>
</body>
</html>
```

#### 权限说明
- 此接口为支付宝支付完成后跳转页面，无需用户认证
