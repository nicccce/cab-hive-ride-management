...
// ## 最近订单
// - 订单ID：order_789 状态：completed 时间：2023-08-15 10:30

// ## 对话历史
// 14:25 [user]: 我想成为平台司机
// 14:26 [assistant]: 欢迎您申请成为我们的司机！请告诉我您想了解的具体内容。

// ## 当前问题
// 如何注册为司机？

// 以下是与问题相关的知识库内容：
// - 司机注册流程：微信登录->个人中心->司机注册->填写资料->提交审核->等待审核结果 (相似度: 0.85)
// - 注册所需材料：身份证、驾驶证、行驶证、车辆照片 (相似度: 0.78)
// - 审核时间：通常1-3个工作日完成资质审核 (相似度: 0.72)
